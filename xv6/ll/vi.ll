...
define dso_local noundef i32 @vi_main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  %3 = tail call fastcc ptr @xzalloc(i32 noundef 1056) #15
  ...
  %7 = tail call fastcc ptr @xzalloc(i32 noundef 2) #15
  ...
  tail call fastcc void @write1(ptr noundef nonnull @.str) #15
...
15:                                               ; preds = %103, %2
  ...
  tail call fastcc void @rawmode() #15
  ...
  tail call fastcc void @bb_free(ptr noundef %25) #15
  ...
  %28 = tail call fastcc ptr @xmalloc(i32 noundef 1928) #15
  ...
  tail call fastcc void @screen_erase() #15
  br label %31
...
38:                                               ; preds = %31
  %39 = tail call fastcc i32 @init_text_buffer(ptr noundef %19) #15
...
64:                                               ; preds = %61
  %65 = tail call ptr @strchr(ptr noundef nonnull %62, i8 noundef signext 10) #16
...
73:                                               ; preds = %67, %64
  ...
  tail call fastcc void @colon(ptr noundef nonnull %62) #15
  br label %61, !llvm.loop !42

75:                                               ; preds = %52
  tail call fastcc void @redraw(i32 noundef 0) #15
...
82:                                               ; preds = %77
  %83 = tail call fastcc i32 @readit() #15
  ...
  %87 = tail call fastcc ptr @begin_line(ptr noundef %86) #15
...
91:                                               ; preds = %82
  ...
  %92 = tail call fastcc ptr @begin_line(ptr noundef %86) #15
  %93 = tail call fastcc ptr @end_line(ptr noundef %86) #15
  tail call fastcc void @text_yank(ptr noundef %92, ptr noundef %93, i32 noundef 27, i32 noundef 0) #15
  br label %94

94:                                               ; preds = %91, %82
  tail call fastcc void @do_cmd(i32 noundef %83) #15
...
99:                                               ; preds = %94
  tail call fastcc void @refresh(i32 noundef 0) #15
  tail call fastcc void @show_status_line() #15
...
103:                                              ; preds = %77
  tail call fastcc void @go_bottom_and_clear_to_eol() #15
  tail call fastcc void @cookmode() #15
...
110:                                              ; preds = %103
  tail call fastcc void @write1(ptr noundef nonnull @.str.1) #15
  ret i32 0
}
...
define internal fastcc noundef nonnull ptr @xzalloc(i32 noundef %0) unnamed_addr #0 {
  %2 = tail call fastcc ptr @xmalloc(i32 noundef %0) #15
  %3 = tail call ptr @memset(ptr noundef nonnull %2, i32 noundef 0, i32 noundef %0) #16
  ret ptr %2
}

; Function Attrs: minsize nounwind optsize
define internal fastcc void @write1(ptr noundef %0) unnamed_addr #0 {
  tail call void @fputstr(i32 noundef 1, ptr noundef %0) #16
  ret void
}
...
define dso_local noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  %3 = tail call i32 @vi_main(i32 noundef %0, ptr noundef %1) #15
  ret i32 0
}
...
define internal fastcc nonnull ptr @xmalloc(i32 noundef %0) unnamed_addr #0 {
  ...
  %3 = tail call ptr @malloc(i32 noundef %2) #16
  %4 = icmp eq ptr %3, null
  br i1 %4, label %5, label %7

5:                                                ; preds = %1
  tail call void @fputstr(i32 noundef 2, ptr noundef nonnull @.str.2) #16
  %6 = tail call i32 @exit(i32 noundef 1) #17
  unreachable
...
define internal fastcc void @rawmode() unnamed_addr #0 {
  ...
  %3 = tail call i32 @ttyraw(i32 noundef 1) #16
  ret void
}
...
define internal fastcc range(i32 -1, -2147483648) i32 @init_text_buffer(ptr noundef %0) unnamed_addr #0 {
  ...
  tail call fastcc void @bb_free(ptr noundef %3) #15
  ...
  %6 = tail call fastcc ptr @xzalloc(i32 noundef 10240) #15
  ...
  tail call fastcc void @update_filename(ptr noundef %0) #15
  %11 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %12 = load ptr, ptr %11, align 4, !tbaa !29
  %13 = tail call fastcc i32 @file_insert(ptr noundef %0, ptr noundef %12, i32 noundef 1) #15
...
22:                                               ; preds = %1, %18
  %23 = tail call fastcc ptr @char_insert(ptr noundef %17, i8 noundef signext 10) #15
...
25:                                               ; preds = %22, %18
  ...
  %30 = tail call ptr @memset(ptr noundef nonnull %29, i32 noundef 0, i32 noundef 112) #16
  ret i32 %13
}

; Function Attrs: minsize nounwind optsize
define internal fastcc void @redraw(i32 noundef range(i32 0, 2) %0) unnamed_addr #0 {
  tail call fastcc void @write1(ptr noundef nonnull @.str.50) #15
  tail call fastcc void @screen_erase() #15
  %2 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
5:                                                ; preds = %0
  %6 = tail call fastcc i32 @bb_readc() #15
  %7 = icmp eq i32 %6, 27
  br i1 %7, label %8, label %35

8:                                                ; preds = %5
  %9 = tail call i32 @pause(i32 noundef 2) #16
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %1) #18
  %10 = call i32 @read_nb(i32 noundef 0, ptr noundef nonnull %1, i32 noundef 1) #16
...
16:                                               ; preds = %14, %14
  %17 = call fastcc i32 @bb_readc() #15
...
23:                                               ; preds = %16
  %24 = call fastcc i32 @bb_readc() #15
  br label %40

25:                                               ; preds = %16
  %26 = call fastcc i32 @bb_readc() #15
  br label %40

27:                                               ; preds = %16
  %28 = call fastcc i32 @bb_readc() #15
  br label %40

29:                                               ; preds = %16
  %30 = call fastcc i32 @bb_readc() #15
  br label %40

31:                                               ; preds = %16
  %32 = call fastcc i32 @bb_readc() #15
  br label %40

33:                                               ; preds = %16
  %34 = call fastcc i32 @bb_readc() #15
  br label %40
...
38:                                               ; preds = %35
  call fastcc void @go_bottom_and_clear_to_eol() #15
  call fastcc void @cookmode() #15
  call void @fputstr(i32 noundef 2, ptr noundef nonnull @.str.51) #16
  call void @fputstr(i32 noundef 2, ptr noundef nonnull @.str.45) #16
  %39 = call i32 @exit(i32 noundef 1) #17
  unreachable
...
define internal fastcc ptr @begin_line(ptr noundef %0) unnamed_addr #4 {
  %2 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %3 = load ptr, ptr %2, align 4, !tbaa !29
  %4 = icmp ugt ptr %0, %3
...
define internal fastcc void @text_yank(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef range(i32 0, -1) %3) unnamed_addr #0 {
  ...
  %16 = tail call fastcc ptr @xstrndup(ptr noundef %13, i32 noundef %15) #15
  ...
  tail call fastcc void @bb_free(ptr noundef %8) #15
  ret void
}

; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none)
define internal fastcc ptr @end_line(ptr noundef %0) unnamed_addr #4 {
  %2 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
7:                                                ; preds = %1
  ...
  %10 = xor i32 %9, -1
  %11 = add i32 %8, %10
  %12 = tail call fastcc ptr @bb_memchr(ptr noundef %0, i32 noundef %11) #15
...
define internal fastcc void @do_cmd(i32 noundef %0) unnamed_addr #0 {
  ...
  %8 = call ptr @memset(ptr noundef nonnull %4, i32 noundef 0, i32 noundef 12) #16
  ...
  call fastcc void @show_status_line() #15
...
38:                                               ; preds = %37
  %39 = call fastcc ptr @yank_delete(ptr noundef nonnull %20, ptr noundef nonnull %20, i32 noundef 0, i32 noundef 1) #15
  %40 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
42:                                               ; preds = %37, %37, %38, %32, %30
  ...
  %45 = call fastcc ptr @char_insert(ptr noundef %43, i8 noundef signext %44) #15
...
56:                                               ; preds = %52, %50
  ...
  %60 = call fastcc ptr @char_insert(ptr noundef %58, i8 noundef signext %59) #15
...
85:                                               ; preds = %63
  ...
  call fastcc void @not_implemented(ptr noundef %4) #15
  br label %1146
...
88:                                               ; preds = %63, %63
  ...
  %92 = add i32 %91, -2
  call fastcc void @dot_scroll(i32 noundef %92, i32 noundef -1) #15
  br label %1146
...
93:                                               ; preds = %63
  ...
  %97 = add i32 %96, -2
  %98 = lshr i32 %97, 1
  call fastcc void @dot_scroll(i32 noundef %98, i32 noundef 1) #15
  br label %1146

99:                                               ; preds = %63
  call fastcc void @dot_scroll(i32 noundef 1, i32 noundef 1) #15
  br label %1146
...
100:                                              ; preds = %63, %63
  ...
  %104 = add i32 %103, -2
  call fastcc void @dot_scroll(i32 noundef %104, i32 noundef 1) #15
  br label %1146
...
120:                                              ; preds = %126, %115
  ...
  %122 = call fastcc ptr @next_line(ptr noundef %121) #15
  %123 = call fastcc ptr @end_line(ptr noundef %121) #15
  %124 = icmp eq ptr %122, %123
  br i1 %124, label %125, label %126

125:                                              ; preds = %120
  call fastcc void @indicate_error() #15
  br label %1146
...
131:                                              ; preds = %130, %130
  call fastcc void @dot_skip_over_ws() #15
  br label %1146
...
136:                                              ; preds = %132
  %137 = call fastcc ptr @end_line(ptr noundef %122) #15
  br label %140

138:                                              ; preds = %132
  %139 = call fastcc ptr @move_to_col(ptr noundef %122, i32 noundef %134) #15
  br label %140
...
143:                                              ; preds = %63, %63
  call fastcc void @redraw(i32 noundef 1) #15
  br label %1146
...
144:                                              ; preds = %63
  ...
  %148 = add i32 %147, -2
  %149 = lshr i32 %148, 1
  call fastcc void @dot_scroll(i32 noundef %149, i32 noundef -1) #15
  br label %1146
...
238:                                              ; preds = %230
  %239 = call fastcc signext i8 @what_reg() #15
  %240 = zext nneg i8 %239 to i32
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.52, i32 noundef %240) #15
  br label %1146
...
252:                                              ; preds = %249
  ...
  %255 = call fastcc ptr @end_line(ptr noundef %254) #15
...
265:                                              ; preds = %264, %262
  %266 = call ptr @strchr(ptr noundef nonnull %236, i8 noundef signext 10) #16
  %267 = icmp eq ptr %266, null
  br i1 %267, label %268, label %272

268:                                              ; preds = %265
  %269 = call i32 @strlen(ptr noundef nonnull %236) #16
  %270 = mul i32 %269, %244
  %271 = add i32 %270, -1
  br label %272
...
275:                                              ; preds = %275, %272
  ...
  %279 = call fastcc i32 @string_insert(ptr noundef %278, ptr noundef nonnull %236) #15
...
294:                                              ; preds = %289
  ...
  %297 = call fastcc ptr @begin_line(ptr noundef %296) #15
  %298 = call fastcc ptr @end_line(ptr noundef %296) #15
  %299 = call fastcc ptr @text_hole_delete(ptr noundef %297, ptr noundef %298) #15
  ...
  %303 = call fastcc i32 @string_insert(ptr noundef %299, ptr noundef %302) #15
...
311:                                              ; preds = %317, %307
  ...
  %313 = call fastcc ptr @end_line(ptr noundef %312) #15
...
334:                                              ; preds = %331
  %335 = call ptr @strchr(ptr noundef nonnull @.str.53, i8 noundef signext %332) #16
  %336 = icmp eq ptr %335, null
  br i1 %336, label %373, label %337

337:                                              ; preds = %334
  %338 = load i8, ptr %327, align 1, !tbaa !24
  %339 = call ptr @strchr(ptr noundef nonnull @.str.53, i8 noundef signext %338) #16
...
438:                                              ; preds = %63, %63
  ...
  %441 = call fastcc ptr @get_input_line(ptr noundef nonnull %4) #15
...
455:                                              ; preds = %444
  call fastcc void @bb_free(ptr noundef %450) #15
  %456 = call fastcc ptr @xstrdup(ptr noundef nonnull %441) #15
...
477:                                              ; preds = %466
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.31) #15
  br label %1146
...
478:                                              ; preds = %473, %514
  ...
  %486 = call fastcc ptr @char_search(ptr noundef nonnull %482, ptr noundef nonnull %485, i32 noundef %475) #15
...
498:                                              ; preds = %494, %492
  ...
  %503 = call fastcc ptr @char_search(ptr noundef %499, ptr noundef nonnull %502, i32 noundef %475) #15
...
512:                                              ; preds = %510
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull %511, ptr noundef nonnull @.str.55, ptr noundef nonnull @.str.56) #15
  br label %514

513:                                              ; preds = %510
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull %511, ptr noundef nonnull @.str.56, ptr noundef nonnull @.str.55) #15
  br label %514
...
573:                                              ; preds = %63
  %574 = call fastcc ptr @get_input_line(ptr noundef nonnull @.str.57) #15
  call fastcc void @colon(ptr noundef nonnull %574) #15
  br label %1146
...
575:                                              ; preds = %63, %63
  ...
  %580 = call fastcc i32 @count_lines(ptr noundef %577, ptr noundef %579) #15
  %581 = call fastcc i32 @find_range(ptr noundef %2, ptr noundef %3, i32 noundef %0) #15
...
583:                                              ; preds = %575
  ...
  %586 = call fastcc i32 @count_lines(ptr noundef %584, ptr noundef %585) #15
  %587 = call fastcc ptr @begin_line(ptr noundef %584) #15
...
596:                                              ; preds = %594
  %597 = call fastcc ptr @text_hole_delete(ptr noundef nonnull %590, ptr noundef nonnull %590) #15
  br label %616
...
607:                                              ; preds = %602
  %608 = call fastcc ptr @text_hole_delete(ptr noundef nonnull %590, ptr noundef nonnull %590) #15
  %609 = add nuw nsw i32 %600, 1
  %610 = load i8, ptr %590, align 1, !tbaa !24
  br label %598, !llvm.loop !68

611:                                              ; preds = %593
  %612 = call fastcc ptr @end_line(ptr noundef %590) #15
  %613 = icmp eq ptr %590, %612
  br i1 %613, label %616, label %614

614:                                              ; preds = %611
  %615 = call fastcc ptr @char_insert(ptr noundef %590, i8 noundef signext 9) #15
  br label %616

616:                                              ; preds = %598, %602, %594, %596, %614, %611
  %617 = add nsw i32 %591, -1
  %618 = call fastcc ptr @next_line(ptr noundef %590) #15
  br label %589, !llvm.loop !69

619:                                              ; preds = %589
  %620 = call fastcc ptr @find_line(i32 noundef %580) #15
...
650:                                              ; preds = %642
  %651 = call fastcc ptr @skip_thing(ptr noundef nonnull %641, i32 noundef 1, i32 noundef %634, i32 noundef 2) #15
  store ptr %651, ptr %637, align 4, !tbaa !43
  %652 = call fastcc ptr @skip_thing(ptr noundef %651, i32 noundef 2, i32 noundef %634, i32 noundef 3) #15
  store ptr %652, ptr %637, align 4, !tbaa !43
  br label %653

653:                                              ; preds = %650, %642
  %654 = phi ptr [ %652, %650 ], [ %641, %642 ]
  %655 = call fastcc ptr @skip_thing(ptr noundef %654, i32 noundef 1, i32 noundef %634, i32 noundef 1) #15
  br label %659

656:                                              ; preds = %640
  %657 = call fastcc ptr @skip_thing(ptr noundef %641, i32 noundef 1, i32 noundef 1, i32 noundef 2) #15
  store ptr %657, ptr %637, align 4, !tbaa !43
  %658 = call fastcc ptr @skip_thing(ptr noundef %657, i32 noundef 2, i32 noundef 1, i32 noundef 3) #15
  br label %659
...
664:                                              ; preds = %63, %63
  ...
  %668 = call fastcc ptr @end_line(ptr noundef %667) #15
  %669 = load i8, ptr %668, align 1, !tbaa !24
  %670 = icmp eq i8 %669, 10
  br i1 %670, label %671, label %679

671:                                              ; preds = %664
  %672 = call fastcc ptr @begin_line(ptr noundef nonnull %668) #15
...
679:                                              ; preds = %664, %671
  ...
  %681 = call fastcc ptr @yank_delete(ptr noundef %667, ptr noundef nonnull %680, i32 noundef 0, i32 noundef 1) #15
...
710:                                              ; preds = %702
  %711 = call fastcc ptr @find_line(i32 noundef %703) #15
...
753:                                              ; preds = %748, %748
  %754 = call fastcc ptr @text_hole_delete(ptr noundef nonnull %751, ptr noundef nonnull %751) #15
...
762:                                              ; preds = %63
  %763 = call fastcc ptr @end_screen() #15
...
792:                                              ; preds = %788
  %793 = call fastcc ptr @next_line(ptr noundef %789) #15
...
798:                                              ; preds = %797, %796
  ...
  %802 = call fastcc ptr @char_insert(ptr noundef %801, i8 noundef signext 10) #15
...
821:                                              ; preds = %813
  %822 = call fastcc ptr @yank_delete(ptr noundef %816, ptr noundef %816, i32 noundef 0, i32 noundef 1) #15
...
839:                                              ; preds = %837, %836
  ...
  %841 = call fastcc ptr @yank_delete(ptr noundef nonnull %840, ptr noundef nonnull %840, i32 noundef 0, i32 noundef 1) #15
...
865:                                              ; preds = %860
  ...
  %872 = call fastcc i32 @file_write(ptr noundef %867, ptr noundef %868, ptr noundef nonnull %871) #15
...
876:                                              ; preds = %874
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.58) #15
  br label %892
...
904:                                              ; preds = %892
  ...
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.25, i32 noundef %898) #15
  br label %1146
...
934:                                              ; preds = %927
  %935 = call fastcc ptr @skip_thing(ptr noundef nonnull %921, i32 noundef %917, i32 noundef %910, i32 noundef 3) #15
...
950:                                              ; preds = %948
  %951 = call fastcc i32 @bb_ispunct(i32 noundef %939) #15
  %952 = icmp eq i32 %951, 0
  br i1 %952, label %956, label %953

953:                                              ; preds = %950, %938, %948
  %954 = phi i32 [ 5, %948 ], [ 5, %938 ], [ 4, %950 ]
  %955 = call fastcc ptr @skip_thing(ptr noundef nonnull %941, i32 noundef 1, i32 noundef %910, i32 noundef %954) #15
...
961:                                              ; preds = %63, %63, %63, %63
  ...
  %966 = call fastcc i32 @find_range(ptr noundef %2, ptr noundef %3, i32 noundef %0) #15
...
973:                                              ; preds = %968
  %974 = call fastcc ptr @begin_line(ptr noundef %970) #15
  %975 = load ptr, ptr %3, align 4, !tbaa !18
  %976 = call fastcc ptr @end_line(ptr noundef %975) #15
  br label %977
...
977:                                              ; preds = %971, %973
  ...
  %981 = call fastcc ptr @yank_delete(ptr noundef %979, ptr noundef %978, i32 noundef %966, i32 noundef %965) #15
...
985:                                              ; preds = %984
  %986 = call fastcc ptr @char_insert(ptr noundef %981, i8 noundef signext 10) #15
...
1003:                                             ; preds = %1009, %998
  ...
  %1005 = call fastcc ptr @prev_line(ptr noundef %1004) #15
  %1006 = call fastcc ptr @begin_line(ptr noundef %1004) #15
...
1020:                                             ; preds = %1016
  %1021 = call fastcc ptr @end_line(ptr noundef %1005) #15
  br label %1024

1022:                                             ; preds = %1016
  %1023 = call fastcc ptr @move_to_col(ptr noundef %1005, i32 noundef %1018) #15
  br label %1024
...
1027:                                             ; preds = %63
  %1028 = call fastcc i32 @readit() #15
...
1030:                                             ; preds = %1027
  ...
  %1034 = call fastcc ptr @end_line(ptr noundef %1033) #15
...
1045:                                             ; preds = %1042, %1045
  ...
  %1047 = call fastcc ptr @text_hole_delete(ptr noundef %1046, ptr noundef %1046) #15
  ...
  %1050 = call fastcc ptr @char_insert(ptr noundef %1047, i8 noundef signext %1043) #15
...
1070:                                             ; preds = %1068
  %1071 = call fastcc i32 @bb_ispunct(i32 noundef %1061) #15
  %1072 = icmp eq i32 %1071, 0
  br i1 %1072, label %1076, label %1073

1073:                                             ; preds = %1070, %1058, %1068
  %1074 = phi i32 [ 5, %1068 ], [ 5, %1058 ], [ 4, %1070 ]
  %1075 = call fastcc ptr @skip_thing(ptr noundef nonnull %1059, i32 noundef 1, i32 noundef 1, i32 noundef %1074) #15
...
1091:                                             ; preds = %1083
  %1092 = call fastcc ptr @skip_thing(ptr noundef nonnull %1084, i32 noundef 2, i32 noundef 1, i32 noundef 3) #15
...
1098:                                             ; preds = %63
  %1099 = call fastcc i32 @readit() #15
...
1110:                                             ; preds = %1098, %1101, %1106
  ...
  %1114 = call fastcc ptr @begin_line(ptr noundef %1113) #15
  %1115 = getelementptr inbounds nuw i8, ptr %1100, i32 76
  store ptr %1114, ptr %1115, align 4, !tbaa !49
  call fastcc void @dot_scroll(i32 noundef %1111, i32 noundef -1) #15
  br label %1146
...
1116:                                             ; preds = %63
  ...
  %1123 = call fastcc ptr @move_to_col(ptr noundef %1119, i32 noundef %1122) #15
...
1156:                                             ; preds = %1146
  %1157 = call fastcc ptr @char_insert(ptr noundef %1151, i8 noundef signext 10) #15
...
1168:                                             ; preds = %1163
  %1169 = call fastcc ptr @bound_dot(ptr noundef %1165) #15
...
1176:                                             ; preds = %1172
  ...
  %1178 = call ptr @strchr(ptr noundef nonnull @.str.66, i8 noundef signext %1177) #16
...
1193:                                             ; preds = %1191, %1187
  ...
  %1196 = call fastcc ptr @begin_line(ptr noundef %1195) #15
...
define internal fastcc void @refresh(i32 noundef range(i32 0, 2) %0) unnamed_addr #0 {
  ...
  %7 = tail call fastcc ptr @begin_line(ptr noundef %4) #15
...
11:                                               ; preds = %1
  %12 = tail call fastcc i32 @count_lines(ptr noundef %7, ptr noundef nonnull %9) #15
...
26:                                               ; preds = %22
  %27 = tail call fastcc ptr @prev_line(ptr noundef %23) #15
  store ptr %27, ptr %8, align 4, !tbaa !49
  %28 = add nuw i32 %24, 1
  br label %22, !llvm.loop !84

29:                                               ; preds = %1
  %30 = tail call fastcc ptr @end_screen() #15
...
36:                                               ; preds = %29
  %37 = tail call fastcc i32 @count_lines(ptr noundef %30, ptr noundef nonnull %7) #15
...
50:                                               ; preds = %45
  %51 = tail call fastcc ptr @next_line(ptr noundef %46) #15
  store ptr %51, ptr %8, align 4, !tbaa !49
  %52 = tail call fastcc ptr @next_line(ptr noundef %48) #15
  %53 = tail call fastcc ptr @end_line(ptr noundef %52) #15
...
64:                                               ; preds = %58
  %65 = tail call fastcc ptr @next_line(ptr noundef %59) #15
...
75:                                               ; preds = %70
  %76 = tail call fastcc i32 @next_column(i8 noundef signext %73, i32 noundef %72) #15
...
183:                                              ; preds = %181
  ...
  %185 = tail call ptr @memmove(ptr noundef nonnull %128, ptr noundef nonnull %184, i32 noundef %177) #16
...
208:                                              ; preds = %201
  ...
  %211 = tail call ptr @memset(ptr noundef nonnull %209, i32 noundef 32, i32 noundef %210) #16
  br label %212
...
218:                                              ; preds = %212
  ...
  %221 = sub i32 %219, %220
  %222 = tail call fastcc ptr @bb_memchr(ptr noundef %119, i32 noundef %221) #15
...
269:                                              ; preds = %227, %260
  ...
  %280 = tail call ptr @memmove(ptr noundef %276, ptr noundef nonnull %277, i32 noundef %279) #16
  tail call fastcc void @place_cursor(i32 noundef %120, i32 noundef %275) #15
  %281 = tail call i32 @write(i32 noundef 1, ptr noundef %276, i32 noundef range(i32 -2147483647, -2147483648) %279) #16
...
286:                                              ; preds = %117
  ...
  tail call fastcc void @place_cursor(i32 noundef %288, i32 noundef %290) #15
...
5:                                                ; preds = %0
  ...
  %9 = tail call fastcc i32 @count_lines(ptr noundef %6, ptr noundef %8) #15
...
18:                                               ; preds = %5
  ...
  %22 = tail call fastcc i32 @count_lines(ptr noundef %8, ptr noundef nonnull %21) #15
  %23 = add i32 %9, -1
  %24 = add i32 %23, %22
...
34:                                               ; preds = %29, %32
  ...
  %55 = tail call i32 (ptr, i32, ptr, ...) @bb_snprintf(ptr noundef nonnull %41, i32 noundef %42, ptr nonnull poison, i32 noundef %48, ptr noundef nonnull %52, ptr noundef nonnull %54, i32 noundef %37, i32 noundef %35, i32 noundef %36) #15
...
76:                                               ; preds = %0, %72, %67
  ...
  tail call fastcc void @write1(ptr noundef nonnull %80) #15
...
85:                                               ; preds = %76
  ...
  %87 = tail call i32 @strlen(ptr noundef nonnull %86) #16
...
98:                                               ; preds = %94
  tail call fastcc void @Hit_Return() #15
...
103:                                              ; preds = %100, %76
  ...
  tail call fastcc void @place_cursor(i32 noundef %106, i32 noundef %108) #15
  br label %109
...
define internal fastcc void @go_bottom_and_clear_to_eol() unnamed_addr #0 {
  ...
  %4 = add i32 %3, -1
  tail call fastcc void @place_cursor(i32 noundef %4, i32 noundef 0) #15
  tail call fastcc void @write1(ptr noundef nonnull @.str.71) #15
  ret void
}

; Function Attrs: minsize nounwind optsize
define internal fastcc void @cookmode() unnamed_addr #0 {
  %1 = tail call i32 @ttyraw(i32 noundef 0) #16
  ret void
}
...
define internal fastcc void @screen_erase() unnamed_addr #0 {
  ...
  %6 = tail call ptr @memset(ptr noundef %3, i32 noundef 32, i32 noundef %5) #16
  ret void
}
...
6:                                                ; preds = %1
  tail call fastcc void @bb_free(ptr noundef %4) #15
  %7 = tail call fastcc ptr @xstrdup(ptr noundef %0) #15
  %8 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
define internal fastcc range(i32 -1, -2147483648) i32 @file_insert(ptr noundef %0, ptr noundef %1, i32 noundef range(i32 0, 2) %2) unnamed_addr #0 {
  ...
  %13 = tail call i32 @open(ptr noundef %0, i32 noundef 0) #16
...
17:                                               ; preds = %15
  tail call fastcc void @status_line_bold_errno(ptr noundef %0) #15
  br label %52

18:                                               ; preds = %3
  %19 = call i32 @fstat(i32 noundef %13, ptr noundef nonnull %4) #16
  %20 = icmp slt i32 %19, 0
  br i1 %20, label %21, label %22

21:                                               ; preds = %18
  call fastcc void @status_line_bold_errno(ptr noundef %0) #15
  br label %49
...
26:                                               ; preds = %22
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.3, ptr noundef %0) #15
  br label %49
...
27:                                               ; preds = %22
  ...
  %31 = call fastcc i32 @text_hole_make(ptr noundef %12, i32 noundef %30) #15
...
36:                                               ; preds = %33
  ...
  %39 = call i32 @read(i32 noundef range(i32 0, -2147483648) %13, ptr noundef %37, i32 noundef %38) #16
...
44:                                               ; preds = %42
  ...
  %48 = call fastcc ptr @text_hole_delete(ptr noundef %45, ptr noundef nonnull %47) #15
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.4, ptr noundef %0) #15
  br label %49

49:                                               ; preds = %44, %42, %26, %21
  %50 = phi i32 [ -1, %21 ], [ %34, %44 ], [ %34, %42 ], [ -1, %26 ]
  %51 = call i32 @close(i32 noundef %13) #16
  br label %52
...
define internal fastcc ptr @char_insert(ptr noundef %0, i8 noundef signext %1) unnamed_addr #0 {
  %3 = tail call fastcc ptr @begin_line(ptr noundef %0) #15
...
4:                                                ; preds = %2
  %5 = tail call fastcc i32 @stupid_insert(ptr noundef %0, i8 noundef signext 94) #15
  %6 = getelementptr inbounds nuw i8, ptr %0, i32 %5
  tail call fastcc void @refresh(i32 noundef 0) #15
  %7 = tail call fastcc i32 @readit() #15
  %8 = trunc i32 %7 to i8
...
40:                                               ; preds = %33, %36
  ...
  %45 = tail call fastcc i32 @get_column(ptr noundef %44) #15
...
56:                                               ; preds = %52
  %57 = tail call fastcc i32 @get_column(ptr noundef nonnull %53) #15
...
59:                                               ; preds = %56
  ...
  %64 = tail call fastcc ptr @text_hole_delete(ptr noundef nonnull %63, ptr noundef nonnull %63) #15
...
86:                                               ; preds = %83
  ...
  %88 = tail call fastcc ptr @text_hole_delete(ptr noundef nonnull %87, ptr noundef nonnull %87) #15
  br label %98
...
89:                                               ; preds = %72
  ...
  %95 = tail call fastcc i32 @stupid_insert(ptr noundef %0, i8 noundef signext %91) #15
...
define internal fastcc noundef nonnull ptr @xstrdup(ptr noundef %0) unnamed_addr #0 {
  %2 = tail call i32 @strlen(ptr noundef %0) #16
  %3 = add nsw i32 %2, 1
  %4 = tail call fastcc ptr @xmalloc(i32 noundef %3) #15
  %5 = tail call ptr @strcpy(ptr noundef nonnull %4, ptr noundef %0) #16
  ret ptr %4
}
...
define internal fastcc void @status_line_bold_errno(ptr noundef %0) unnamed_addr #0 {
  tail call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.5, ptr noundef %0) #15
  ret void
}
...
define internal void @status_line_bold(ptr noundef readonly captures(none) %0, ...) unnamed_addr #0 {
  ...
  %5 = call ptr @strcpy(ptr noundef nonnull %4, ptr noundef nonnull @.str.6) #16
  ...
  %10 = call fastcc i32 @bb_vsnprintf(ptr noundef nonnull %7, i32 noundef 191, ptr noundef %0, [1 x i32] %9) #15
...
21:                                               ; preds = %14
  %22 = tail call fastcc ptr @xmalloc(i32 noundef %19) #15
  br label %31
...
23:                                               ; preds = %14
  ...
  %26 = shl i32 %25, 3
  %27 = add i32 %26, -8
  %28 = tail call fastcc ptr @xmalloc(i32 noundef %19) #15
  %29 = tail call i32 @llvm.smin.i32(i32 %27, i32 %19)
  %30 = tail call ptr @memmove(ptr noundef nonnull %28, ptr noundef nonnull %9, i32 noundef %29) #16
...
61:                                               ; preds = %59, %4
  ...
  %70 = sub i32 %68, %69
  %71 = tail call ptr @memmove(ptr noundef nonnull %65, ptr noundef %63, i32 noundef %70) #16
  %72 = tail call ptr @memset(ptr noundef %63, i32 noundef 32, i32 noundef %1) #16
  br label %73
...
28:                                               ; preds = %23
  %29 = tail call ptr @memmove(ptr noundef %4, ptr noundef nonnull %6, i32 noundef %14) #16
...
define internal fastcc i32 @bb_vsnprintf(ptr noundef writeonly captures(none) %0, i32 noundef range(i32 1, 134217728) %1, ptr noundef readonly captures(none) %2, [1 x i32] %3) unnamed_addr #6 {
...
define internal fastcc i32 @stupid_insert(ptr noundef %0, i8 noundef signext %1) unnamed_addr #0 {
  %3 = tail call fastcc i32 @text_hole_make(ptr noundef %0, i32 noundef 1) #15
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none)
define internal fastcc range(i32 -2147483647, -2147483648) i32 @get_column(ptr noundef readonly %0) unnamed_addr #4 {
  %2 = tail call fastcc ptr @begin_line(ptr noundef %0) #15
  br label %3
...
7:                                                ; preds = %3
  ...
  %9 = tail call fastcc i32 @next_column(i8 noundef signext %8, i32 noundef %5) #15
...
define internal fastcc range(i32 -2147483647, -2147483648) i32 @next_column(i8 noundef signext %0, i32 noundef %1) unnamed_addr #7 {
  %3 = icmp eq i8 %0, 9
...
; Function Attrs: minsize optsize
declare dso_local ptr @strchr(ptr noundef, i8 noundef signext) local_unnamed_addr #2
...
9:                                                ; preds = %4
  %10 = tail call fastcc ptr @skip_whitespace(ptr noundef nonnull %5) #15
...
33:                                               ; preds = %31
  ...
  %39 = tail call fastcc i32 @count_lines(ptr noundef %35, ptr noundef nonnull %38) #15
  br label %217
...
40:                                               ; preds = %31
  ...
  %44 = tail call fastcc i32 @count_lines(ptr noundef %41, ptr noundef %43) #15
  br label %45
...
72:                                               ; preds = %68
  ...
  %77 = tail call fastcc i32 @count_lines(ptr noundef %50, ptr noundef nonnull %76) #15
  br label %188
...
98:                                               ; preds = %91
  %99 = tail call fastcc i32 @count_lines(ptr noundef %52, ptr noundef nonnull %96) #15
  br label %188
...
111:                                              ; preds = %108
  ...
  tail call fastcc void @bb_free(ptr noundef %113) #15
  %114 = tail call fastcc ptr @xstrndup(ptr noundef nonnull %55, i32 noundef %101) #15
...
127:                                              ; preds = %118
  %128 = tail call fastcc ptr @next_line(ptr noundef %126) #15
  br label %131

129:                                              ; preds = %118
  %130 = tail call fastcc ptr @begin_line(ptr noundef %126) #15
  br label %131
...
131:                                              ; preds = %129, %127
  ...
  %137 = tail call fastcc ptr @char_search(ptr noundef %132, ptr noundef nonnull %136, i32 noundef %133) #15
...
147:                                              ; preds = %143, %141
  ...
  %152 = tail call fastcc ptr @char_search(ptr noundef %148, ptr noundef nonnull %151, i32 noundef %133) #15
...
154:                                              ; preds = %147, %131
  ...
  %158 = tail call fastcc i32 @count_lines(ptr noundef %157, ptr noundef nonnull %155) #15
  br label %188
...
212:                                              ; preds = %211
  %213 = tail call fastcc ptr @find_line(i32 noundef %20) #15
...
228:                                              ; preds = %78, %91, %147
  ...
  tail call void (ptr, ...) @status_line_bold(ptr noundef nonnull %229) #15
...
253:                                              ; preds = %247
  ...
  %255 = call fastcc ptr @skip_non_whitespace(ptr noundef %2) #15
...
258:                                              ; preds = %253
  %259 = call i32 @strlen(ptr noundef nonnull %2) #16
...
267:                                              ; preds = %258, %253, %266, %264
  ...
  %269 = call fastcc ptr @skip_non_whitespace(ptr noundef %234) #15
  %270 = call fastcc ptr @skip_whitespace(ptr noundef nonnull %269) #15
...
280:                                              ; preds = %278
  %281 = call fastcc i32 @count_lines(ptr noundef %272, ptr noundef nonnull %275) #15
  %282 = icmp sgt i32 %20, %281
  br i1 %282, label %283, label %284

283:                                              ; preds = %280, %278
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.9) #15
  br label %796

284:                                              ; preds = %280
  %285 = call fastcc ptr @find_line(i32 noundef %20) #15
  %286 = and i32 %21, 3
...
295:                                              ; preds = %292
  %296 = call fastcc ptr @find_line(i32 noundef %19) #15
  br label %297

297:                                              ; preds = %284, %295
  %298 = phi ptr [ %296, %295 ], [ %285, %284 ]
  %299 = call fastcc ptr @end_line(ptr noundef %285) #15
  br label %300

300:                                              ; preds = %297, %267
  %301 = phi ptr [ %275, %267 ], [ %299, %297 ]
  %302 = phi ptr [ %272, %267 ], [ %298, %297 ]
  %303 = call i32 @strlen(ptr noundef nonnull %2) #16
...
307:                                              ; preds = %305
  %308 = call fastcc ptr @find_line(i32 noundef %20) #15
...
319:                                              ; preds = %318
  ...
  %324 = call fastcc i32 @count_lines(ptr noundef %321, ptr noundef %323) #15
  br label %325

325:                                              ; preds = %319, %318
  %326 = phi i32 [ %324, %319 ], [ %20, %318 ]
  call void (ptr, ...) @status_line(ptr noundef nonnull @.str.10, i32 noundef %326) #15
  br label %796

327:                                              ; preds = %311
  %328 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.11, i32 noundef %303) #15
...
331:                                              ; preds = %330
  ...
  %335 = call fastcc ptr @begin_line(ptr noundef %334) #15
  %336 = call fastcc ptr @end_line(ptr noundef %334) #15
  br label %337

337:                                              ; preds = %331, %330
  %338 = phi ptr [ %301, %330 ], [ %336, %331 ]
  %339 = phi ptr [ %302, %330 ], [ %335, %331 ]
  %340 = call fastcc ptr @yank_delete(ptr noundef %339, ptr noundef %338, i32 noundef 1, i32 noundef 1) #15
...
343:                                              ; preds = %327
  %344 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.12, i32 noundef %303) #15
...
352:                                              ; preds = %346
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.13, ptr noundef nonnull %2) #15
  br label %796
...
360:                                              ; preds = %356
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.14) #15
  br label %796

361:                                              ; preds = %353, %356
  %362 = phi ptr [ %358, %356 ], [ %270, %353 ]
  %363 = call fastcc i32 @init_text_buffer(ptr noundef nonnull %362) #15
  ...
  call fastcc void @bb_free(ptr noundef %366) #15
  ...
  call fastcc void @bb_free(ptr noundef %373) #15
  ...
  %385 = call fastcc i32 @count_lines(ptr noundef %381, ptr noundef nonnull %384) #15
  %386 = ptrtoint ptr %383 to i32
  %387 = ptrtoint ptr %381 to i32
  %388 = sub i32 %386, %387
  call void (ptr, ...) @status_line(ptr noundef nonnull @.str.15, ptr noundef nonnull %362, ptr noundef nonnull %380, i32 noundef %385, i32 noundef %388) #15
  br label %796

389:                                              ; preds = %343
  %390 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.18, i32 noundef %303) #15
...
394:                                              ; preds = %392
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.19) #15
  br label %796
...
398:                                              ; preds = %395
  call fastcc void @update_filename(ptr noundef nonnull %270) #15
  br label %796
...
402:                                              ; preds = %389
  %403 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.20, i32 noundef %303) #15
...
405:                                              ; preds = %402
  call fastcc void @go_bottom_and_clear_to_eol() #15
  call fastcc void @cookmode() #15
  call void @fputstr(i32 noundef 1, ptr noundef nonnull @.str.44) #16
  call void @fputstr(i32 noundef 1, ptr noundef nonnull @.str.45) #16
  call fastcc void @rawmode() #15
  call fastcc void @Hit_Return() #15
  br label %796

406:                                              ; preds = %402
  %407 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.21, i32 noundef %303) #15
...
411:                                              ; preds = %409
  ...
  %414 = call fastcc ptr @begin_line(ptr noundef %413) #15
  %415 = call fastcc ptr @end_line(ptr noundef %413) #15
  br label %416
...
436:                                              ; preds = %434
  %437 = call fastcc ptr @stpcpy(ptr noundef %423, ptr noundef nonnull @.str.6) #15
  %438 = getelementptr inbounds nuw i8, ptr %437, i32 1
  store i8 46, ptr %437, align 1, !tbaa !24
  %439 = call fastcc ptr @stpcpy(ptr noundef nonnull %438, ptr noundef nonnull @.str.7) #15
  br label %453
...
457:                                              ; preds = %406
  %458 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.22, i32 noundef %303) #15
  %459 = icmp eq i32 %458, 0
  br i1 %459, label %466, label %460

460:                                              ; preds = %457
  %461 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.23, i32 noundef %303) #15
  %462 = icmp eq i32 %461, 0
  br i1 %462, label %466, label %463

463:                                              ; preds = %460
  %464 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.24, i32 noundef %303) #15
...
490:                                              ; preds = %481
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.25, i32 noundef %486) #15
  br label %796
...
495:                                              ; preds = %491
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.26) #15
  br label %796
...
500:                                              ; preds = %498
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.27) #15
  br label %796
...
505:                                              ; preds = %463
  %506 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.28, i32 noundef %303) #15
...
524:                                              ; preds = %523
  %525 = call fastcc ptr @find_line(i32 noundef %20) #15
...
531:                                              ; preds = %527, %524
  ...
  %534 = call fastcc ptr @next_line(ptr noundef %533) #15
...
542:                                              ; preds = %531, %520
  ...
  %546 = call fastcc i32 @count_lines(ptr noundef %543, ptr noundef %545) #15
  %547 = getelementptr inbounds nuw i8, ptr %544, i32 4
  %548 = load ptr, ptr %547, align 4, !tbaa !48
  %549 = call fastcc i32 @file_insert(ptr noundef nonnull %518, ptr noundef %545, i32 noundef 0) #15
...
551:                                              ; preds = %542
  ...
  %563 = call fastcc i32 @count_lines(ptr noundef %560, ptr noundef nonnull %562) #15
  call void (ptr, ...) @status_line(ptr noundef nonnull @.str.29, ptr noundef nonnull %518, i32 noundef %563, i32 noundef %549) #15
  %564 = call fastcc ptr @find_line(i32 noundef %554) #15
  %565 = getelementptr inbounds nuw i8, ptr %555, i32 8
  store ptr %564, ptr %565, align 4, !tbaa !43
  br label %796

566:                                              ; preds = %505
  %567 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.30, i32 noundef %303) #15
...
580:                                              ; preds = %578
  ...
  %582 = call fastcc ptr @skip_whitespace(ptr noundef nonnull %581) #15
  %583 = load i8, ptr %582, align 1, !tbaa !24
  %584 = getelementptr inbounds nuw i8, ptr %582, i32 1
  %585 = call ptr @strchr(ptr noundef nonnull %584, i8 noundef signext %583) #16
...
587:                                              ; preds = %580
  ...
  %592 = call ptr @strchr(ptr noundef nonnull %591, i8 noundef signext %583) #16
...
604:                                              ; preds = %598
  call fastcc void @bb_free(ptr noundef %603) #15
  %605 = call fastcc ptr @xstrdup(ptr noundef nonnull %582) #15
...
613:                                              ; preds = %608
  %614 = call i32 @strlen(ptr noundef nonnull %609) #16
  br label %615
...
618:                                              ; preds = %615
  ...
  %622 = call fastcc ptr @begin_line(ptr noundef %621) #15
  %623 = call fastcc ptr @end_line(ptr noundef %621) #15
  %624 = load ptr, ptr %619, align 4, !tbaa !29
  %625 = call fastcc i32 @count_lines(ptr noundef %624, ptr noundef %622) #15
  br label %630
...
630:                                              ; preds = %626, %618
  ...
  %634 = call i32 @strlen(ptr noundef nonnull %591) #16
...
641:                                              ; preds = %636, %661
  ...
  %645 = call fastcc ptr @char_search(ptr noundef %644, ptr noundef nonnull %616, i32 noundef 2) #15
...
647:                                              ; preds = %641
  ...
  %650 = call fastcc ptr @text_hole_delete(ptr noundef nonnull %645, ptr noundef nonnull %649) #15
  br i1 %635, label %655, label %651

651:                                              ; preds = %647
  %652 = call fastcc i32 @string_insert(ptr noundef nonnull %645, ptr noundef nonnull %591) #15
...
661:                                              ; preds = %655
  ...
  %663 = call fastcc ptr @end_line(ptr noundef %656) #15
...
665:                                              ; preds = %661, %655, %641
  ...
  %668 = call fastcc ptr @next_line(ptr noundef %667) #15
...
672:                                              ; preds = %670
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.32) #15
  br label %796
...
674:                                              ; preds = %578
  %675 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.33, i32 noundef %303) #15
  %676 = icmp eq i32 %675, 0
  br i1 %676, label %677, label %678

677:                                              ; preds = %674
  call void (ptr, ...) @status_line(ptr noundef nonnull @.str.34) #15
  br label %796

678:                                              ; preds = %674
  %679 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.35, i32 noundef %303) #15
  %680 = icmp eq i32 %679, 0
  br i1 %680, label %693, label %681

681:                                              ; preds = %678
  %682 = call i32 @strcmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.36) #16
  %683 = icmp eq i32 %682, 0
  br i1 %683, label %693, label %684

684:                                              ; preds = %681
  %685 = call i32 @strcmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.37) #16
...
702:                                              ; preds = %700
  %703 = call i32 @strcmp(ptr noundef nonnull %696, ptr noundef nonnull %270) #16
  %704 = icmp eq i32 %703, 0
  br i1 %704, label %708, label %705

705:                                              ; preds = %702, %700
  %706 = call i32 @stat(ptr noundef nonnull %270, ptr noundef nonnull %3) #16
...
710:                                              ; preds = %705
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.38) #15
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %3) #18
  br label %796
...
720:                                              ; preds = %711
  ...
  %723 = add i32 %721, 1
  %724 = sub i32 %723, %722
  %725 = call fastcc i32 @file_write(ptr noundef %713, ptr noundef %302, ptr noundef %301) #15
...
729:                                              ; preds = %727
  call fastcc void @status_line_bold_errno(ptr noundef %713) #15
  br label %796
...
730:                                              ; preds = %711, %720
  ...
  %735 = call fastcc i32 @count_lines(ptr noundef %302, ptr noundef nonnull %734) #15
  call void (ptr, ...) @status_line(ptr noundef nonnull @.str.29, ptr noundef %713, i32 noundef %735, i32 noundef %731) #15
...
769:                                              ; preds = %765
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.25, i32 noundef %763) #15
  br label %796

770:                                              ; preds = %687
  %771 = call fastcc i32 @bb_strncmp(ptr noundef nonnull %2, ptr noundef nonnull @.str.39, i32 noundef %303) #15
...
775:                                              ; preds = %773
  ...
  %778 = call fastcc ptr @begin_line(ptr noundef %777) #15
  %779 = call fastcc ptr @end_line(ptr noundef %777) #15
  br label %780
...
780:                                              ; preds = %775, %773
  ...
  call fastcc void @text_yank(ptr noundef %782, ptr noundef %781, i32 noundef %784, i32 noundef 1) #15
  %785 = call fastcc i32 @count_lines(ptr noundef %782, ptr noundef %781) #15
  ...
  %792 = call i32 @strlen(ptr noundef %791) #16
  %793 = call fastcc signext i8 @what_reg() #15
  %794 = zext nneg i8 %793 to i32
  call void (ptr, ...) @status_line(ptr noundef nonnull @.str.40, i32 noundef %785, i32 noundef %792, i32 noundef %794) #15
  br label %796

795:                                              ; preds = %770
  call fastcc void @not_implemented(ptr noundef %2) #15
  br label %796
...
796:                                              ; preds = %730, %756, %751, %767, %672, %673, %612, %710, %769, %727, %729, %283, %294, %228, %551, %516, %542, %503, %473, %480, %490, %495, %500, %361, %352, %360, %9, %9, %307, %305, %337, %399, %398, %455, %795, %780, %677, %575, %576, %405, %325, %394
  ...
  %800 = call fastcc ptr @bound_dot(ptr noundef %799) #15
...
803:                                              ; preds = %580
  call void (ptr, ...) @status_line(ptr noundef nonnull @.str.41) #15
  br label %804
...
define internal fastcc noundef ptr @skip_whitespace(ptr noundef readonly captures(ret: address, provenance) %0) unnamed_addr #8 {
  br label %2
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(argmem: read)
define internal fastcc noundef nonnull ptr @skip_non_whitespace(ptr noundef nonnull readonly captures(ret: address, provenance) %0) unnamed_addr #8 {
  br label %2
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none)
define internal fastcc i32 @count_lines(ptr noundef readonly %0, ptr noundef readonly %1) unnamed_addr #4 {
  %3 = icmp ult ptr %1, %0
  %4 = select i1 %3, ptr %0, ptr %1
  %5 = select i1 %3, ptr %1, ptr %0
  %6 = tail call fastcc ptr @end_line(ptr noundef %4) #15
...
17:                                               ; preds = %13
  %18 = tail call fastcc ptr @end_line(ptr noundef %10) #15
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none)
define internal fastcc ptr @find_line(i32 noundef %0) unnamed_addr #4 {
  %2 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %3 = load ptr, ptr %2, align 4, !tbaa !29
  br label %4
...
8:                                                ; preds = %4
  %9 = tail call fastcc ptr @next_line(ptr noundef %6) #15
  %10 = add nsw i32 %5, -1
...
define internal fastcc void @dot_skip_over_ws() unnamed_addr #9 {
  %1 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
define internal void @status_line(ptr noundef readonly captures(none) %0, ...) unnamed_addr #10 {
  %2 = alloca %struct.__va_list, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %2) #18
  call void @llvm.va_start.p0(ptr nonnull %2)
  %3 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  ...
  %7 = call fastcc i32 @bb_vsnprintf(ptr noundef nonnull %4, i32 noundef 200, ptr noundef %0, [1 x i32] %6) #15
  call void @llvm.va_end.p0(ptr nonnull %2)
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(argmem: read)
define internal fastcc range(i32 -255, 256) i32 @bb_strncmp(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1, i32 noundef %2) unnamed_addr #8 {
  br label %4
...
12:                                               ; preds = %9, %4
  ...
  tail call fastcc void @text_yank(ptr noundef %7, ptr noundef %6, i32 noundef %15, i32 noundef %2) #15
  %16 = icmp eq i32 %3, 0
  br i1 %16, label %19, label %17

17:                                               ; preds = %12
  %18 = tail call fastcc ptr @text_hole_delete(ptr noundef %7, ptr noundef %6) #15
  br label %19
...
define internal fastcc void @Hit_Return() unnamed_addr #0 {
  tail call fastcc void @write1(ptr noundef nonnull @.str.6) #15
  tail call fastcc void @write1(ptr noundef nonnull @.str.46) #15
  tail call fastcc void @write1(ptr noundef nonnull @.str.7) #15
  br label %1

1:                                                ; preds = %1, %0
  %2 = tail call fastcc i32 @readit() #15
...
3:                                                ; preds = %1, %1
  tail call fastcc void @redraw(i32 noundef 1) #15
  ret void
}

; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(argmem: readwrite)
define internal fastcc noundef ptr @stpcpy(ptr noundef writeonly captures(ret: address, provenance) %0, ptr noundef readonly captures(none) %1) unnamed_addr #11 {
  br label %3
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none)
define internal fastcc ptr @next_line(ptr noundef readonly %0) unnamed_addr #4 {
  %2 = tail call fastcc ptr @end_line(ptr noundef %0) #15
  %3 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
define internal fastcc ptr @char_search(ptr noundef readonly %0, ptr noundef %1, i32 noundef %2) unnamed_addr #0 {
  %4 = tail call i32 @strlen(ptr noundef %1) #16
  %5 = and i32 %2, 1
  %6 = icmp sgt i32 %2, 0
  %7 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
13:                                               ; preds = %8
  %14 = tail call fastcc ptr @next_line(ptr noundef %0) #15
  br label %15
...
20:                                               ; preds = %17
  %21 = tail call fastcc i32 @bb_strncmp(ptr noundef %18, ptr noundef %1, i32 noundef %4) #15
  %22 = icmp eq i32 %21, 0
...
28:                                               ; preds = %25
  %29 = tail call fastcc ptr @prev_line(ptr noundef %0) #15
  br label %30
...
37:                                               ; preds = %34
  %38 = tail call fastcc i32 @bb_strncmp(ptr noundef %35, ptr noundef %1, i32 noundef %4) #15
  %39 = icmp eq i32 %38, 0
...
define internal fastcc i32 @string_insert(ptr noundef %0, ptr noundef %1) unnamed_addr #0 {
  %3 = tail call i32 @strlen(ptr noundef %1) #16
  %4 = tail call fastcc i32 @text_hole_make(ptr noundef %0, i32 noundef %3) #15
  %5 = getelementptr inbounds nuw i8, ptr %0, i32 %4
  %6 = tail call ptr @memmove(ptr noundef %5, ptr noundef %1, i32 noundef %3) #16
  ret i32 %4
}
...
5:                                                ; preds = %3
  tail call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.14) #15
  br label %18

6:                                                ; preds = %3
  %7 = tail call i32 @open(ptr noundef nonnull %0, i32 noundef 1537) #16
  %8 = icmp slt i32 %7, 0
...
9:                                                ; preds = %6
  ...
  %12 = sub i32 %10, %11
  %13 = add nsw i32 %12, 1
  %14 = tail call i32 @write(i32 noundef range(i32 0, -2147483648) %7, ptr noundef %1, i32 noundef range(i32 -2147483647, -2147483648) %13) #16
  %15 = icmp eq i32 %14, %13
  %16 = select i1 %15, i32 %14, i32 0
  %17 = tail call i32 @close(i32 noundef %7) #16
  br label %18
...
; Function Attrs: minsize mustprogress nofree norecurse nosync nounwind optsize willreturn memory(read, inaccessiblemem: none)
define internal fastcc signext range(i8 68, 123) i8 @what_reg() unnamed_addr #7 {
  %1 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
31:                                               ; preds = %7, %23
  call void (ptr, ...) @status_line_bold(ptr noundef nonnull @.str.47, ptr noundef nonnull %2) #15
...
9:                                                ; preds = %6
  ...
  tail call fastcc void @indicate_error() #15
  %11 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  br label %12
...
12:                                               ; preds = %3, %6
  ...
  %14 = tail call fastcc ptr @xmalloc(i32 noundef %13) #15
  %15 = tail call ptr @memmove(ptr noundef nonnull %14, ptr noundef %0, i32 noundef %4) #16
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none)
define internal fastcc ptr @prev_line(ptr noundef readonly %0) unnamed_addr #4 {
  %2 = tail call fastcc ptr @begin_line(ptr noundef %0) #15
  %3 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
11:                                               ; preds = %6, %1
  %12 = phi ptr [ %2, %1 ], [ %10, %6 ]
  %13 = tail call fastcc ptr @begin_line(ptr noundef %12) #15
  ret ptr %13
}
...
define internal fastcc void @indicate_error() unnamed_addr #0 {
  ...
  tail call fastcc void @write1(ptr noundef nonnull @.str.49) #15
  ret void
}
...
define internal fastcc range(i32 -1, 256) i32 @bb_readc() unnamed_addr #0 {
  %1 = alloca i8, align 1
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %1) #18
  %2 = call i32 @read(i32 noundef 0, ptr noundef nonnull %1, i32 noundef 1) #16
  %3 = icmp slt i32 %2, 1
...
; Function Attrs: minsize optsize
declare dso_local i32 @read_nb(i32 noundef, ptr noundef, i32 noundef) local_unnamed_addr #2

; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(argmem: read)
define internal fastcc ptr @bb_memchr(ptr noundef readonly captures(ret: address, provenance) %0, i32 noundef %1) unnamed_addr #8 {
  br label %3
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(readwrite, inaccessiblemem: none)
define internal fastcc void @dot_scroll(i32 noundef %0, i32 noundef range(i32 -1, 2) %1) unnamed_addr #9 {
  %3 = icmp slt i32 %1, 0
...
11:                                               ; preds = %9
  %12 = tail call fastcc ptr @prev_line(ptr noundef %10) #15
  br label %15

13:                                               ; preds = %9
  %14 = tail call fastcc ptr @next_line(ptr noundef %10) #15
  br label %15
...
24:                                               ; preds = %23, %18
  ...
  %26 = tail call fastcc ptr @end_screen() #15
  %27 = icmp ugt ptr %25, %26
  br i1 %27, label %28, label %30

28:                                               ; preds = %24
  %29 = tail call fastcc ptr @begin_line(ptr noundef %26) #15
  store ptr %29, ptr %19, align 4, !tbaa !43
  br label %30

30:                                               ; preds = %28, %24
  tail call fastcc void @dot_skip_over_ws() #15
  ret void
}
...
define internal fastcc void @dot_left() unnamed_addr #12 {
  %1 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %2 = getelementptr inbounds nuw i8, ptr %1, i32 8
  %3 = load ptr, ptr %2, align 4, !tbaa !43
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none)
define internal fastcc ptr @move_to_col(ptr noundef readonly %0, i32 noundef %1) unnamed_addr #4 {
  %3 = tail call fastcc ptr @begin_line(ptr noundef %0) #15
  %4 = load ptr, ptr @ptr_to_globals, align 4
...
11:                                               ; preds = %6
  %12 = tail call fastcc i32 @next_column(i8 noundef signext %9, i32 noundef %8) #15
...
; Function Attrs: minsize mustprogress nofree norecurse nosync nounwind optsize willreturn memory(readwrite, inaccessiblemem: none)
define internal fastcc void @dot_right() unnamed_addr #12 {
  %1 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %2 = getelementptr inbounds nuw i8, ptr %1, i32 8
  %3 = load ptr, ptr %2, align 4, !tbaa !43
  %4 = getelementptr inbounds nuw i8, ptr %1, i32 4
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(readwrite, inaccessiblemem: none)
define internal fastcc void @dot_begin() unnamed_addr #9 {
  %1 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %2 = getelementptr inbounds nuw i8, ptr %1, i32 8
  %3 = load ptr, ptr %2, align 4, !tbaa !43
  %4 = tail call fastcc ptr @begin_line(ptr noundef %3) #15
  store ptr %4, ptr %2, align 4, !tbaa !43
  ret void
}

; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(readwrite, inaccessiblemem: none)
define internal fastcc void @dot_next() unnamed_addr #9 {
  %1 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %2 = getelementptr inbounds nuw i8, ptr %1, i32 8
  %3 = load ptr, ptr %2, align 4, !tbaa !43
  %4 = tail call fastcc ptr @next_line(ptr noundef %3) #15
  store ptr %4, ptr %2, align 4, !tbaa !43
  ret void
}
...
define internal fastcc nonnull ptr @get_input_line(ptr noundef %0) unnamed_addr #0 {
  ...
  tail call fastcc void @write1(ptr noundef nonnull %9) #15
...
31:                                               ; preds = %26
  ...
  call fastcc void @write1(ptr noundef nonnull %33) #15
  br label %34
...
39:                                               ; preds = %36
  ...
  %45 = call i32 @write(i32 noundef 1, ptr noundef nonnull %2, i32 noundef 1) #16
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %2) #18
  br label %34

46:                                               ; preds = %26, %17, %17, %17, %16
  call fastcc void @refresh(i32 noundef 0) #15
...
8:                                                ; preds = %3
  %9 = tail call fastcc i32 @readit() #15
  %10 = add nsw i32 %9, -58
...
19:                                               ; preds = %14
  ...
  %22 = tail call fastcc i32 @readit() #15
...
37:                                               ; preds = %3, %32
  ...
  %40 = tail call ptr @strchr(ptr noundef nonnull @.str.59, i8 noundef signext %39) #16
...
48:                                               ; preds = %42
  tail call fastcc void @do_cmd(i32 noundef 106) #15
...
53:                                               ; preds = %35, %37
  ...
  %56 = tail call ptr @strchr(ptr noundef nonnull @.str.60, i8 noundef signext %54) #16
  %57 = icmp eq ptr %56, null
  br i1 %57, label %66, label %58

58:                                               ; preds = %53
  %59 = tail call ptr @strchr(ptr noundef nonnull @.str.61, i8 noundef signext %54) #16
  %60 = icmp eq ptr %59, null
  %61 = select i1 %60, i32 0, i32 2
  tail call fastcc void @do_cmd(i32 noundef %55) #15
...
66:                                               ; preds = %53
  %67 = tail call ptr @strchr(ptr noundef nonnull @.str.62, i8 noundef signext %54) #16
...
74:                                               ; preds = %69
  %75 = tail call fastcc i32 @at_eof(ptr noundef nonnull %72) #15
  %76 = icmp eq i32 %75, 0
...
79:                                               ; preds = %77
  ...
  %81 = sext i8 %80 to i32
  %82 = tail call fastcc i32 @bb_ispunct(i32 noundef %81) #15
  %83 = icmp eq i32 %82, 0
...
112:                                              ; preds = %66
  %113 = tail call ptr @strchr(ptr noundef nonnull @.str.63, i8 noundef signext %54) #16
...
149:                                              ; preds = %139
  ...
  %151 = tail call ptr @strchr(ptr noundef nonnull @.str.64, i8 noundef signext %150) #16
...
155:                                              ; preds = %149
  %156 = tail call ptr @strchr(ptr noundef nonnull @.str.65, i8 noundef signext %150) #16
  %157 = icmp eq ptr %156, null
  br i1 %157, label %178, label %158

158:                                              ; preds = %155
  %159 = tail call fastcc ptr @begin_line(ptr noundef %146) #15
...
164:                                              ; preds = %161
  %165 = tail call fastcc i32 @at_eof(ptr noundef nonnull %147) #15
...
168:                                              ; preds = %161, %164, %158
  ...
  %170 = tail call fastcc i32 @at_eof(ptr noundef nonnull %147) #15
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(readwrite, inaccessiblemem: none)
define internal fastcc void @dot_end() unnamed_addr #9 {
  %1 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %2 = getelementptr inbounds nuw i8, ptr %1, i32 8
  %3 = load ptr, ptr %2, align 4, !tbaa !43
  %4 = tail call fastcc ptr @end_line(ptr noundef %3) #15
  store ptr %4, ptr %2, align 4, !tbaa !43
  ret void
}

; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none)
define internal fastcc noundef ptr @skip_thing(ptr noundef readonly captures(address, ret: address, provenance) %0, i32 noundef range(i32 1, 3) %1, i32 noundef range(i32 -1, 2) %2, i32 noundef range(i32 1, 6) %3) unnamed_addr #4 {
  %5 = icmp sgt i32 %2, -1
...
29:                                               ; preds = %9
  ...
  %31 = tail call fastcc i32 @bb_ispunct(i32 noundef %30) #15
  %32 = icmp eq i32 %31, 0
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none)
define internal fastcc ptr @end_screen() unnamed_addr #4 {
  %1 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
...
11:                                               ; preds = %7
  %12 = tail call fastcc ptr @next_line(ptr noundef %8) #15
  %13 = add nuw i32 %9, 1
  br label %7, !llvm.loop !139

14:                                               ; preds = %7
  %15 = tail call fastcc ptr @end_line(ptr noundef %8) #15
  ret ptr %15
}

; Function Attrs: minsize nofree norecurse nosync nounwind optsize memory(readwrite, inaccessiblemem: none)
define internal fastcc void @dot_prev() unnamed_addr #9 {
  %1 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %2 = getelementptr inbounds nuw i8, ptr %1, i32 8
  %3 = load ptr, ptr %2, align 4, !tbaa !43
  %4 = tail call fastcc ptr @prev_line(ptr noundef %3) #15
  store ptr %4, ptr %2, align 4, !tbaa !43
  ret void
}

; Function Attrs: minsize mustprogress nofree norecurse nosync nounwind optsize willreturn memory(none)
define internal fastcc range(i32 0, 2) i32 @bb_ispunct(i32 noundef range(i32 -128, 128) %0) unnamed_addr #13 {
  %2 = add nsw i32 %0, -33
  %3 = icmp ult i32 %2, 94
  br i1 %3, label %4, label %12
...
; Function Attrs: minsize mustprogress nofree norecurse nosync nounwind optsize willreturn memory(read, inaccessiblemem: none)
define internal fastcc range(i32 0, 2) i32 @at_eof(ptr noundef readonly captures(address) %0) unnamed_addr #7 {
  %2 = load ptr, ptr @ptr_to_globals, align 4, !tbaa !3
  %3 = getelementptr inbounds nuw i8, ptr %2, i32 4
  %4 = load ptr, ptr %3, align 4, !tbaa !48
...
define internal fastcc void @place_cursor(i32 noundef %0, i32 noundef %1) unnamed_addr #0 {
  ...
  call void (ptr, ptr, ...) @bb_sprintf(ptr noundef %3, ptr nonnull poison, i32 noundef %14, i32 noundef %16) #15
  call fastcc void @write1(ptr noundef nonnull %3) #15
  call void @llvm.lifetime.end.p0(i64 33, ptr nonnull %3) #18
  ret void
}

; Function Attrs: minsize nofree norecurse nosync nounwind optsize
define internal void @bb_sprintf(ptr noundef nonnull writeonly captures(none) %0, ptr readnone captures(none) %1, ...) unnamed_addr #10 {
  %3 = alloca %struct.__va_list, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %3) #18
  call void @llvm.va_start.p0(ptr nonnull %3)
  %4 = load i32, ptr %3, align 4
  %5 = insertvalue [1 x i32] poison, i32 %4, 0
  %6 = call fastcc i32 @bb_vsnprintf(ptr noundef nonnull %0, i32 noundef 134217727, ptr noundef nonnull @.str.67, [1 x i32] %5) #15
...
; Function Attrs: minsize nofree norecurse nosync nounwind optsize
define internal i32 @bb_snprintf(ptr noundef writeonly captures(none) %0, i32 noundef range(i32 1, 201) %1, ptr readnone captures(none) %2, ...) unnamed_addr #10 {
  %4 = alloca %struct.__va_list, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %4) #18
  call void @llvm.va_start.p0(ptr nonnull %4)
  %5 = load i32, ptr %4, align 4
  %6 = insertvalue [1 x i32] poison, i32 %5, 0
  %7 = call fastcc i32 @bb_vsnprintf(ptr noundef %0, i32 noundef %1, ptr noundef nonnull @.str.68, [1 x i32] %6) #15
...
attributes #4 = { minsize nofree norecurse nosync nounwind optsize memory(read, inaccessiblemem: none) "no-builtins" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m0" "target-features"="+armv6-m,+strict-align,+thumb-mode,-aes,-bf16,-d32,-dotprod,-fp-armv8,-fp-armv8d16,-fp-armv8d16sp,-fp-armv8sp,-fp16,-fp16fml,-fp64,-fpregs,-fullfp16,-mve.fp,-neon,-sha2,-vfp2,-vfp2sp,-vfp3,-vfp3d16,-vfp3d16sp,-vfp3sp,-vfp4,-vfp4d16,-vfp4d16sp,-vfp4sp" }
...
attributes #10 = { minsize nofree norecurse nosync nounwind optsize "no-builtins" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m0" "target-features"="+armv6-m,+strict-align,+thumb-mode,-aes,-bf16,-d32,-dotprod,-fp-armv8,-fp-armv8d16,-fp-armv8d16sp,-fp-armv8sp,-fp16,-fp16fml,-fp64,-fpregs,-fullfp16,-mve.fp,-neon,-sha2,-vfp2,-vfp2sp,-vfp3,-vfp3d16,-vfp3d16sp,-vfp3sp,-vfp4,-vfp4d16,-vfp4d16sp,-vfp4sp" }
attributes #11 = { minsize nofree norecurse nosync nounwind optsize memory(argmem: readwrite) "no-builtins" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m0" "target-features"="+armv6-m,+strict-align,+thumb-mode,-aes,-bf16,-d32,-dotprod,-fp-armv8,-fp-armv8d16,-fp-armv8d16sp,-fp-armv8sp,-fp16,-fp16fml,-fp64,-fpregs,-fullfp16,-mve.fp,-neon,-sha2,-vfp2,-vfp2sp,-vfp3,-vfp3d16,-vfp3d16sp,-vfp3sp,-vfp4,-vfp4d16,-vfp4d16sp,-vfp4sp" }
...
attributes #17 = { minsize nobuiltin noreturn nounwind optsize "no-builtins" }
