...
@.str.15 = private unnamed_addr constant [87 x i8] c"toolbox: kill spin trap free sync mount umount wc mkdir rm gpio mux blink fbtest show\0A\00", align 1
...
@.str.34 = private unnamed_addr constant [51 x i8] c"builtin: cd\0Acommands (flash registry, /dev/apps):\0A\00", align 1
@.str.35 = private unnamed_addr constant [10 x i8] c"/dev/apps\00", align 1
@.str.36 = private unnamed_addr constant [20 x i8] c"help: no /dev/apps\0A\00", align 1
...
@.str.44 = private unnamed_addr constant [21 x i8] c"usage: mkdir dir...\0A\00", align 1
@.str.45 = private unnamed_addr constant [15 x i8] c"mkdir: failed\0A\00", align 1
@.str.46 = private unnamed_addr constant [19 x i8] c"usage: rm file...\0A\00", align 1
@.str.47 = private unnamed_addr constant [12 x i8] c"rm: failed\0A\00", align 1
@.str.48 = private unnamed_addr constant [5 x i8] c"read\00", align 1
@.str.49 = private unnamed_addr constant [15 x i8] c"gpio: bad pin\0A\00", align 1
@.str.50 = private unnamed_addr constant [3 x i8] c"1\0A\00", align 1
@.str.51 = private unnamed_addr constant [3 x i8] c"0\0A\00", align 1
@.str.52 = private unnamed_addr constant [6 x i8] c"write\00", align 1
@.str.53 = private unnamed_addr constant [43 x i8] c"usage: gpio write PIN 0|1 | gpio read PIN\0A\00", align 1
@t_mux.roles = internal unnamed_addr constant [9 x %struct.anon] [%struct.anon { ptr @.str.54, i32 1 }, %struct.anon { ptr @.str.55, i32 2 }, %struct.anon { ptr @.str.56, i32 3 }, %struct.anon { ptr @.str.57, i32 4 }, %struct.anon { ptr @.str.58, i32 5 }, %struct.anon { ptr @.str.59, i32 6 }, %struct.anon { ptr @.str.60, i32 7 }, %struct.anon { ptr @.str.61, i32 8 }, %struct.anon { ptr @.str.62, i32 31 }], align 4
@.str.54 = private unnamed_addr constant [4 x i8] c"spi\00", align 1
@.str.55 = private unnamed_addr constant [5 x i8] c"uart\00", align 1
@.str.56 = private unnamed_addr constant [4 x i8] c"i2c\00", align 1
@.str.57 = private unnamed_addr constant [4 x i8] c"pwm\00", align 1
@.str.58 = private unnamed_addr constant [4 x i8] c"sio\00", align 1
@.str.59 = private unnamed_addr constant [5 x i8] c"pio0\00", align 1
@.str.60 = private unnamed_addr constant [5 x i8] c"pio1\00", align 1
@.str.61 = private unnamed_addr constant [5 x i8] c"pio2\00", align 1
@.str.62 = private unnamed_addr constant [5 x i8] c"none\00", align 1
@.str.63 = private unnamed_addr constant [22 x i8] c"mux: bad pin or role\0A\00", align 1
@.str.64 = private unnamed_addr constant [59 x i8] c"usage: mux PIN spi|uart|i2c|pwm|sio|pio0|pio1|pio2|none|N\0A\00", align 1
@blink_pin = internal unnamed_addr global i32 -1, align 4
@.str.65 = private unnamed_addr constant [36 x i8] c"blinking (soft loop); Ctrl-C stops\0A\00", align 1
@.str.66 = private unnamed_addr constant [4 x i8] c"pio\00", align 1
...
@.str.67 = private unnamed_addr constant [25 x i8] c"blink: pio setup failed\0A\00", align 1
@.str.68 = private unnamed_addr constant [54 x i8] c"blinking on pio0 sm0 (async); `blink stop PIN` stops\0A\00", align 1
@.str.69 = private unnamed_addr constant [5 x i8] c"stop\00", align 1
@.str.70 = private unnamed_addr constant [56 x i8] c"usage: blink gpio PIN | blink pio PIN | blink stop PIN\0A\00", align 1
...
99:                                               ; preds = %93
  %100 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.15, i32 noundef 87) #10
...
define internal fastcc range(i32 0, 2) i32 @t_help() unnamed_addr #4 {
  ...
  %3 = tail call i32 @write(i32 noundef 1, ptr noundef nonnull @.str.34, i32 noundef 50) #10
  %4 = tail call i32 @open(ptr noundef nonnull @.str.35, i32 noundef 0) #10
  %5 = icmp slt i32 %4, 0
  br i1 %5, label %6, label %8

6:                                                ; preds = %0
  %7 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.36, i32 noundef 19) #10
  br label %56
...
10:                                               ; preds = %2
  ...
  %13 = tail call fastcc i32 @streq(ptr noundef %12, ptr noundef nonnull @.str.37) #8
  %14 = icmp eq i32 %13, 0
...
20:                                               ; preds = %17
  %21 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.38, i32 noundef 37) #10
  br label %29
...
25:                                               ; preds = %22
  %26 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.39, i32 noundef 14) #10
  br label %29
...
4:                                                ; preds = %2
  %5 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.41, i32 noundef 19) #10
  br label %13
...
11:                                               ; preds = %6
  %12 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.38, i32 noundef 37) #10
  br label %13
...
13:                                               ; preds = %8
  %14 = icmp slt i32 %6, %0
  %15 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.42, i32 noundef 16) #10
...
4:                                                ; preds = %2
  %5 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.44, i32 noundef 20) #10
  br label %19
...
15:                                               ; preds = %9
  %16 = icmp slt i32 %7, %0
  %17 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.45, i32 noundef 14) #10
...
4:                                                ; preds = %2
  %5 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.46, i32 noundef 18) #10
  br label %19
...
15:                                               ; preds = %9
  %16 = icmp slt i32 %7, %0
  %17 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.47, i32 noundef 11) #10
  %18 = zext i1 %16 to i32
  br label %19
...
4:                                                ; preds = %2
  ...
  %7 = tail call fastcc i32 @streq(ptr noundef %6, ptr noundef nonnull @.str.48) #8
  %8 = icmp eq i32 %7, 0
...
15:                                               ; preds = %9
  %16 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.49, i32 noundef 14) #10
  br label %38

17:                                               ; preds = %9
  %18 = icmp eq i32 %13, 0
  %19 = select i1 %18, ptr @.str.51, ptr @.str.50
...
22:                                               ; preds = %20
  %23 = tail call fastcc i32 @streq(ptr noundef %6, ptr noundef nonnull @.str.52) #8
  %24 = icmp eq i32 %23, 0
...
34:                                               ; preds = %25
  %35 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.49, i32 noundef 14) #10
  br label %38

36:                                               ; preds = %2, %22, %20
  %37 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.53, i32 noundef 42) #10
  br label %38
...
36:                                               ; preds = %30
  %37 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.63, i32 noundef 21) #10
  br label %40

38:                                               ; preds = %27, %2
  %39 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.64, i32 noundef 58) #10
  br label %40
...
11:                                               ; preds = %6
  ...
  tail call void @fputstr(i32 noundef 1, ptr noundef nonnull @.str.65) #10
  br label %16
...
21:                                               ; preds = %6
  %22 = tail call fastcc i32 @streq(ptr noundef %8, ptr noundef nonnull @.str.66) #8
  %23 = icmp eq i32 %22, 0
...
61:                                               ; preds = %58, %54, %50, %34
  %62 = call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.67, i32 noundef 24) #10
  br label %64

63:                                               ; preds = %58
  call void @fputstr(i32 noundef 1, ptr noundef nonnull @.str.68) #10
  br label %64
...
66:                                               ; preds = %21
  %67 = tail call fastcc i32 @streq(ptr noundef %8, ptr noundef nonnull @.str.69) #8
  %68 = icmp eq i32 %67, 0
...
75:                                               ; preds = %2, %66
  %76 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.70, i32 noundef 55) #10
  br label %77
...
3:                                                ; preds = %3, %1
  ...
  br i1 %14, label %15, label %3, !llvm.loop !42
...
32:                                               ; preds = %5
  ...
  tail call fastcc void @emit(ptr noundef nonnull @.str.43) #8
