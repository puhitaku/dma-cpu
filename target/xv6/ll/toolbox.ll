...
@.str.8 = private unnamed_addr constant [6 x i8] c"mount\00", align 1
@.str.9 = private unnamed_addr constant [7 x i8] c"umount\00", align 1
@.str.10 = private unnamed_addr constant [3 x i8] c"wc\00", align 1
@.str.11 = private unnamed_addr constant [6 x i8] c"mkdir\00", align 1
@.str.12 = private unnamed_addr constant [3 x i8] c"rm\00", align 1
@.str.13 = private unnamed_addr constant [87 x i8] c"toolbox: kill spin trap free sync mount umount wc mkdir rm gpio mux blink fbtest show\0A\00", align 1
@.str.14 = private unnamed_addr constant [20 x i8] c"usage: kill pid...\0A\00", align 1
@.str.15 = private unnamed_addr constant [11 x i8] c"spin: pid \00", align 1
...
@.str.18 = private unnamed_addr constant [17 x i8] c"trap: Ctrl-C me\0A\00", align 1
@.str.19 = private unnamed_addr constant [34 x i8] c"\0Acaught SIGINT; exiting politely\0A\00", align 1
@.str.20 = private unnamed_addr constant [22 x i8] c"free: meminfo failed\0A\00", align 1
@.str.21 = private unnamed_addr constant [14 x i8] c"arena: total \00", align 1
@.str.22 = private unnamed_addr constant [8 x i8] c"  used \00", align 1
@.str.23 = private unnamed_addr constant [8 x i8] c"  free \00", align 1
@.str.24 = private unnamed_addr constant [11 x i8] c"  largest \00", align 1
@.str.25 = private unnamed_addr constant [14 x i8] c"\0Aof it: heap \00", align 1
@.str.26 = private unnamed_addr constant [8 x i8] c"  exec \00", align 1
@.str.27 = private unnamed_addr constant [9 x i8] c"\0Aprocs: \00", align 1
@.str.28 = private unnamed_addr constant [2 x i8] c"/\00", align 1
@.str.29 = private unnamed_addr constant [10 x i8] c"  uptime \00", align 1
@.str.30 = private unnamed_addr constant [8 x i8] c" ticks\0A\00", align 1
@.str.31 = private unnamed_addr constant [21 x i8] c"sync: not supported\0A\00", align 1
@.str.32 = private unnamed_addr constant [51 x i8] c"builtin: cd\0Acommands (flash registry, /dev/apps):\0A\00", align 1
@.str.33 = private unnamed_addr constant [10 x i8] c"/dev/apps\00", align 1
@.str.34 = private unnamed_addr constant [20 x i8] c"help: no /dev/apps\0A\00", align 1
@.str.35 = private unnamed_addr constant [8 x i8] c"\1B[2J\1B[H\00", align 1
@.str.36 = private unnamed_addr constant [3 x i8] c"-u\00", align 1
@.str.37 = private unnamed_addr constant [38 x i8] c"umount: failed (busy or not mounted)\0A\00", align 1
@.str.38 = private unnamed_addr constant [15 x i8] c"mount: failed\0A\00", align 1
@.str.39 = private unnamed_addr constant [38 x i8] c"usage: mount [fat0|sd0 DIR | -u DIR]\0A\00", align 1
@.str.40 = private unnamed_addr constant [20 x i8] c"usage: umount /dir\0A\00", align 1
@.str.41 = private unnamed_addr constant [17 x i8] c"wc: cannot open\0A\00", align 1
@wc_one.buf = internal global [512 x i8] zeroinitializer, align 1
@.str.42 = private unnamed_addr constant [2 x i8] c" \00", align 1
@.str.43 = private unnamed_addr constant [21 x i8] c"usage: mkdir dir...\0A\00", align 1
@.str.44 = private unnamed_addr constant [15 x i8] c"mkdir: failed\0A\00", align 1
@.str.45 = private unnamed_addr constant [19 x i8] c"usage: rm file...\0A\00", align 1
@.str.46 = private unnamed_addr constant [12 x i8] c"rm: failed\0A\00", align 1
...
54:                                               ; preds = %51
  ...
  %55 = tail call i32 @exit(i32 noundef 0) #9
  unreachable

56:                                               ; preds = %51
  %57 = tail call fastcc i32 @streq(ptr noundef %11, ptr noundef nonnull @.str.8) #8
  %58 = icmp eq i32 %57, 0
  br i1 %58, label %62, label %59

59:                                               ; preds = %56
  %60 = tail call fastcc i32 @t_mount(i32 noundef %0, ptr noundef %1) #8
  %61 = tail call i32 @exit(i32 noundef %60) #9
  unreachable

62:                                               ; preds = %56
  %63 = tail call fastcc i32 @streq(ptr noundef %11, ptr noundef nonnull @.str.9) #8
  %64 = icmp eq i32 %63, 0
  br i1 %64, label %68, label %65

65:                                               ; preds = %62
  %66 = tail call fastcc i32 @t_umount(i32 noundef %0, ptr noundef %1) #8
  %67 = tail call i32 @exit(i32 noundef %66) #9
  unreachable

68:                                               ; preds = %62
  %69 = tail call fastcc i32 @streq(ptr noundef %11, ptr noundef nonnull @.str.10) #8
  %70 = icmp eq i32 %69, 0
  br i1 %70, label %74, label %71

71:                                               ; preds = %68
  %72 = tail call fastcc i32 @t_wc(i32 noundef %0, ptr noundef %1) #8
  %73 = tail call i32 @exit(i32 noundef %72) #9
  unreachable

74:                                               ; preds = %68
  %75 = tail call fastcc i32 @streq(ptr noundef %11, ptr noundef nonnull @.str.11) #8
  %76 = icmp eq i32 %75, 0
  br i1 %76, label %80, label %77

77:                                               ; preds = %74
  %78 = tail call fastcc i32 @t_mkdir(i32 noundef %0, ptr noundef %1) #8
  %79 = tail call i32 @exit(i32 noundef %78) #9
  unreachable

80:                                               ; preds = %74
  %81 = tail call fastcc i32 @streq(ptr noundef %11, ptr noundef nonnull @.str.12) #8
  %82 = icmp eq i32 %81, 0
  br i1 %82, label %86, label %83

83:                                               ; preds = %80
  %84 = tail call fastcc i32 @t_rm(i32 noundef %0, ptr noundef %1) #8
  %85 = tail call i32 @exit(i32 noundef %84) #9
  unreachable

86:                                               ; preds = %80
  %87 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.13, i32 noundef 87) #10
  %88 = tail call i32 @exit(i32 noundef 1) #9
  unreachable
}
...
4:                                                ; preds = %2
  %5 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.14, i32 noundef 19) #10
  br label %15
...
2:                                                ; preds = %2, %0
  ...
  %4 = tail call i32 @write(i32 noundef 1, ptr noundef nonnull @.str.17, i32 noundef 1) #10
...
define internal fastcc void @t_trap() unnamed_addr #0 {
  ...
  %2 = tail call i32 @write(i32 noundef 1, ptr noundef nonnull @.str.18, i32 noundef 16) #10
  br label %3

3:                                                ; preds = %3, %0
  %4 = tail call i32 @pause(i32 noundef 20) #10
  %5 = tail call i32 @write(i32 noundef 1, ptr noundef nonnull @.str.17, i32 noundef 1) #10
...
4:                                                ; preds = %0
  %5 = call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.20, i32 noundef 21) #10
  br label %25
...
3:                                                ; preds = %0
  %4 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.31, i32 noundef 20) #10
  br label %5
...
define internal fastcc range(i32 0, 2) i32 @t_help() unnamed_addr #4 {
  ...
  %3 = tail call i32 @write(i32 noundef 1, ptr noundef nonnull @.str.32, i32 noundef 50) #10
  %4 = tail call i32 @open(ptr noundef nonnull @.str.33, i32 noundef 0) #10
  %5 = icmp slt i32 %4, 0
  br i1 %5, label %6, label %8

6:                                                ; preds = %0
  %7 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.34, i32 noundef 19) #10
  br label %56
...
define internal fastcc void @t_clear() unnamed_addr #4 {
  %1 = tail call i32 @write(i32 noundef 1, ptr noundef nonnull @.str.35, i32 noundef 7) #10
  ret void
}
...
10:                                               ; preds = %2
  ...
  %13 = tail call fastcc i32 @streq(ptr noundef %12, ptr noundef nonnull @.str.36) #8
  %14 = icmp eq i32 %13, 0
...
20:                                               ; preds = %17
  %21 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.37, i32 noundef 37) #10
  br label %29
...
25:                                               ; preds = %22
  %26 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.38, i32 noundef 14) #10
  br label %29

27:                                               ; preds = %2
  %28 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.39, i32 noundef 37) #10
  br label %29
...
4:                                                ; preds = %2
  %5 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.40, i32 noundef 19) #10
  br label %13
...
11:                                               ; preds = %6
  %12 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.37, i32 noundef 37) #10
  br label %13
...
13:                                               ; preds = %8
  %14 = icmp slt i32 %6, %0
  %15 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.41, i32 noundef 16) #10
...
4:                                                ; preds = %2
  %5 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.43, i32 noundef 20) #10
  br label %19
...
15:                                               ; preds = %9
  %16 = icmp slt i32 %7, %0
  %17 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.44, i32 noundef 14) #10
...
4:                                                ; preds = %2
  %5 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.45, i32 noundef 18) #10
  br label %19
...
15:                                               ; preds = %9
  %16 = icmp slt i32 %7, %0
  %17 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str.46, i32 noundef 11) #10
  %18 = zext i1 %16 to i32
  br label %19
...
define internal void @onint(i32 %0) #0 {
  %2 = tail call i32 @write(i32 noundef 1, ptr noundef nonnull @.str.19, i32 noundef 33) #10
...
32:                                               ; preds = %5
  ...
  tail call fastcc void @emit(ptr noundef nonnull @.str.42) #8
