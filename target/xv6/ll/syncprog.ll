...
@.str = private unnamed_addr constant [21 x i8] c"sync: not supported\0A\00", align 1

; Function Attrs: minsize noreturn nounwind optsize
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  %1 = tail call i32 @sync() #3
  %2 = icmp slt i32 %1, 0
  br i1 %2, label %3, label %6

3:                                                ; preds = %0
  %4 = tail call i32 @write(i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 20) #3
  %5 = tail call i32 @exit(i32 noundef 1) #4
  unreachable

6:                                                ; preds = %0
  %7 = tail call i32 @exit(i32 noundef 0) #4
  unreachable
}

; Function Attrs: minsize optsize
declare dso_local i32 @sync() local_unnamed_addr #1
