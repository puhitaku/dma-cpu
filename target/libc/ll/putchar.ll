; ModuleID = 'putchar.c'
source_filename = "putchar.c"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv6m-unknown-none-eabi"

@stdout = external dso_local local_unnamed_addr constant ptr, align 4

@putchar_unlocked = dso_local alias i32 (i32), ptr @putchar

; Function Attrs: minsize nounwind optsize
define dso_local i32 @putchar(i32 noundef %0) #0 {
  %2 = load ptr, ptr @stdout, align 4, !tbaa !3
  %3 = tail call i32 @fputc(i32 noundef %0, ptr noundef %2) #2
  ret i32 %3
}

; Function Attrs: minsize optsize
declare dso_local i32 @fputc(i32 noundef, ptr noundef) local_unnamed_addr #1
