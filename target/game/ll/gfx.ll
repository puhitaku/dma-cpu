...
9:                                                ; preds = %7
  %10 = mul nsw i32 %1, 240
  %11 = add nsw i32 %10, %0
  %12 = getelementptr inbounds [57600 x i16], ptr @fb, i32 0, i32 %11
...
18:                                               ; preds = %9
  ...
  store i32 %20, ptr @fillword, align 4, !tbaa !3
  %21 = tail call fastcc i32 @halfof(i32 noundef %2) #9
  tail call void @gdma_rows(i32 noundef %13, i32 noundef ptrtoint (ptr @fillword to i32), i32 noundef %21, i32 noundef %3, i32 noundef 480, i32 noundef 0) #8
  br label %35

22:                                               ; preds = %9, %29
  %23 = phi ptr [ %31, %29 ], [ %12, %9 ]
  %24 = phi i32 [ %30, %29 ], [ 0, %9 ]
  %25 = icmp eq i32 %24, %3
  br i1 %25, label %35, label %26

26:                                               ; preds = %22, %32
  %27 = phi i32 [ %34, %32 ], [ 0, %22 ]
  %28 = icmp eq i32 %27, %2
  br i1 %28, label %29, label %32

29:                                               ; preds = %26
  %30 = add nuw i32 %24, 1
  %31 = getelementptr inbounds nuw i8, ptr %23, i32 480
  br label %22, !llvm.loop !7

32:                                               ; preds = %26
  %33 = getelementptr inbounds nuw i16, ptr %23, i32 %27
  store i16 %4, ptr %33, align 2, !tbaa !10
  %34 = add nuw i32 %27, 1
...
35:                                               ; preds = %22, %18
  ...
  %38 = add i32 %1, -1
  %39 = add i32 %38, %3
  tail call void @gfx_damage(i32 noundef %0, i32 noundef %1, i32 noundef %37, i32 noundef %39) #9
  br label %40
...
define dso_local void @gfx_sprite(ptr noundef readonly captures(none) %0, i32 noundef %1, i32 noundef %2, i16 noundef zeroext %3, i16 noundef zeroext %4, ptr noundef writeonly captures(none) %5) local_unnamed_addr #6 {
  %7 = sub nsw i32 32, %1
  %8 = shl nuw i32 1, %7
  br label %9
