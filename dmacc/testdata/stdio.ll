...
3:                                                ; preds = %11
  %4 = call i32 (ptr, i32, ptr, ...) @snprintf(ptr noundef nonnull %1, i32 noundef 48, ptr noundef nonnull @.str.2, i32 noundef -1234, ptr noundef nonnull @.str.3, i32 noundef 49374) #4
  %5 = call i32 @puts(ptr noundef nonnull %1) #4
  %6 = call i32 @strlen(ptr noundef nonnull %1) #4
  %7 = add i32 %4, %22
  %8 = add i32 %7, %6
  %9 = call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.4, i32 noundef %8) #4
...
11:                                               ; preds = %0, %11
  ...
  %13 = phi i32 [ 0, %0 ], [ %23, %11 ]
  %14 = load volatile i32, ptr @base, align 4, !tbaa !3
  %15 = add nsw i32 %14, %13
  %16 = add nsw i32 %13, -2
  %17 = mul nsw i32 %15, %16
  %18 = and i32 %17, 4095
  %19 = add nuw nsw i32 %13, 97
  %20 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.1, i32 noundef %13, i32 noundef %17, i32 noundef %17, i32 noundef %18, i32 noundef %19) #4
  %21 = mul nsw i32 %12, 31
  %22 = add nsw i32 %17, %21
  %23 = add nuw nsw i32 %13, 1
  %24 = icmp eq i32 %23, 5
  br i1 %24, label %3, label %11, !llvm.loop !7
}
...
attributes #2 = { "no-builtins" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cortex-m0" "target-features"="+armv6-m,+strict-align,+thumb-mode,-aes,-bf16,-d32,-dotprod,-fp-armv8,-fp-armv8d16,-fp-armv8d16sp,-fp-armv8sp,-fp16,-fp16fml,-fp64,-fpregs,-fullfp16,-mve.fp,-neon,-sha2,-vfp2,-vfp2sp,-vfp3,-vfp3d16,-vfp3d16sp,-vfp3sp,-vfp4,-vfp4d16,-vfp4d16sp,-vfp4sp" }
