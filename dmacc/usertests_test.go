...
func bootExam(t *testing.T, arg string) *emu.Machine {
	...
	kernC := casm(kcDasm, 0x20004000, 0x20031000)
	ut := casm(utDasm, 0x2003A800, 0x20055000)
	idle := casm(idleDasm, 0x20063800, 0x20064800)
	...
	m.Poke32(mustSym(t, kernC, "g_arena"), 0x20077800)
