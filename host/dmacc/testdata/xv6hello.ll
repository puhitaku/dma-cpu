; ModuleID = 'dmacc/testdata/xv6hello.c'
source_filename = "dmacc/testdata/xv6hello.c"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "thumbv6m-unknown-none-eabi"

@.str = private unnamed_addr constant [17 x i8] c"hello from exec\0A\00", align 1

; Function Attrs: minsize noreturn nounwind optsize
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  %1 = tail call i32 @write(i32 noundef 1, ptr noundef nonnull @.str, i32 noundef 16) #3
  %2 = tail call i32 @exit(i32 noundef 7) #4
  unreachable
}
