...
func examUtDasm(t *testing.T) string {
	...
	utMod, err := llir.Merge(
		parseLL(t, "../../target/xv6/ll/usertests.ll"), parseLL(t, "../../target/xv6/ll/ulib.ll"),
		parseLL(t, "../../target/xv6/ll/printf.ll"), parseLL(t, "../../target/xv6/ll/umalloc.ll"),
...
func bootExam(t *testing.T, arg string) *emu.Machine {
	...
	kernC, err := dmaasm.Assemble(kcDasm, dmaasm.Options{
		Variant: v, Compact: true,
		TextBase: 0x10260000, DataBase: 0x2000EA00, RAMTextBase: 0x20004000,
