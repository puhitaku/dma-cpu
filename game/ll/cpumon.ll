...
@.str.10 = private unnamed_addr constant [22 x i8] c"this screen: 100% DMA\00", align 1
@.str.11 = private unnamed_addr constant [12 x i8] c"press: back\00", align 1
@in_edge = external dso_local local_unnamed_addr global i32, align 4
@.str.12 = private unnamed_addr constant [14 x i8] c"cpumon: back\0A\00", align 1
...
define dso_local void @cpumon_run() local_unnamed_addr #0 {
  ...
  tail call void @gfx_text2(i32 noundef 32, i32 noundef 8, ptr noundef nonnull @.str.1, i16 noundef zeroext -377, i16 noundef zeroext 2147) #3
  tail call fastcc void @draw_chip(i32 noundef 24) #4
  tail call fastcc void @draw_chip(i32 noundef 140) #4
  tail call void @gfx_text(i32 noundef 38, i32 noundef 110, ptr noundef nonnull @.str.2, i16 noundef zeroext -18950, i16 noundef zeroext 2147) #3
  tail call void @gfx_text(i32 noundef 40, i32 noundef 122, ptr noundef nonnull @.str.3, i16 noundef zeroext 27537, i16 noundef zeroext 2147) #3
  tail call void @gfx_text(i32 noundef 154, i32 noundef 110, ptr noundef nonnull @.str.4, i16 noundef zeroext -18950, i16 noundef zeroext 2147) #3
  tail call void @gfx_text(i32 noundef 150, i32 noundef 122, ptr noundef nonnull @.str.5, i16 noundef zeroext 27537, i16 noundef zeroext 2147) #3
  ...
  tail call void @gfx_text(i32 noundef 8, i32 noundef 172, ptr noundef nonnull @.str.7, i16 noundef zeroext -18950, i16 noundef zeroext 2147) #3
  tail call void @gfx_text(i32 noundef 8, i32 noundef 184, ptr noundef nonnull @.str.8, i16 noundef zeroext 27537, i16 noundef zeroext 2147) #3
  tail call void @gfx_text(i32 noundef 8, i32 noundef 196, ptr noundef nonnull @.str.9, i16 noundef zeroext 27537, i16 noundef zeroext 2147) #3
  tail call void @gfx_text(i32 noundef 8, i32 noundef 214, ptr noundef nonnull @.str.10, i16 noundef zeroext 24465, i16 noundef zeroext 2147) #3
  tail call void @gfx_text(i32 noundef 8, i32 noundef 226, ptr noundef nonnull @.str.11, i16 noundef zeroext 27537, i16 noundef zeroext 2147) #3
...
23:                                               ; preds = %16
  ...
  tail call void @uputs(ptr noundef nonnull @.str.12) #3
  ret void
...
28:                                               ; preds = %24
  tail call fastcc void @draw_zzz(i32 noundef 84, i32 noundef %25) #4
  %29 = add i32 %19, 17
  tail call fastcc void @draw_zzz(i32 noundef 190, i32 noundef %29) #4
  tail call void @gfx_present() #3
  br label %30
...
define internal fastcc void @draw_chip(i32 noundef range(i32 24, 141) %0) unnamed_addr #0 {
  tail call void @gfx_fill(i32 noundef %0, i32 noundef 44, i32 noundef 76, i32 noundef 60, i16 noundef zeroext 10601) #3
  tail call void @gfx_rect(i32 noundef %0, i32 noundef 44, i32 noundef 76, i32 noundef 60, i32 noundef 2, i16 noundef zeroext 23346) #3
  %2 = add nsw i32 %0, -5
...
16:                                               ; preds = %13
  ...
  tail call void @gfx_fill(i32 noundef %17, i32 noundef 84, i32 noundef 10, i32 noundef 7, i16 noundef zeroext 4261) #3
  tail call void @gfx_rect(i32 noundef %17, i32 noundef 84, i32 noundef 10, i32 noundef 7, i32 noundef 1, i16 noundef zeroext -8418) #3
  ret void

18:                                               ; preds = %13
  %19 = mul nuw nsw i32 %14, 30
  %20 = add nuw nsw i32 %8, %19
  tail call void @gfx_fill(i32 noundef %20, i32 noundef 70, i32 noundef 3, i32 noundef 2, i16 noundef zeroext -8418) #3
  %21 = add nuw nsw i32 %20, 3
  tail call void @gfx_fill(i32 noundef %21, i32 noundef 72, i32 noundef 6, i32 noundef 2, i16 noundef zeroext -8418) #3
  %22 = add nuw nsw i32 %20, 9
  tail call void @gfx_fill(i32 noundef %22, i32 noundef 70, i32 noundef 3, i32 noundef 2, i16 noundef zeroext -8418) #3
...
define internal fastcc void @draw_idle(i32 noundef %0) unnamed_addr #0 {
  ...
  tail call void @gfx_fill(i32 noundef 150, i32 noundef 150, i32 noundef 80, i32 noundef 16, i16 noundef zeroext 2147) #3
  call void @gfx_text2(i32 noundef 150, i32 noundef 150, ptr noundef nonnull %2, i16 noundef zeroext 24465, i16 noundef zeroext 2147) #3
...
; Function Attrs: minsize nounwind optsize
define internal fastcc void @draw_zzz(i32 noundef range(i32 84, 191) %0, i32 noundef %1) unnamed_addr #0 {
  tail call void @gfx_fill(i32 noundef %0, i32 noundef 40, i32 noundef 48, i32 noundef 34, i16 noundef zeroext 2147) #3
  %3 = lshr i32 %1, 3
  %4 = and i32 %3, 3
  %5 = icmp eq i32 %4, 0
...
6:                                                ; preds = %2
  ...
  tail call void @gfx_text(i32 noundef %7, i32 noundef 64, ptr noundef nonnull @.str.13, i16 noundef zeroext 32351, i16 noundef zeroext 2147) #3
  %8 = icmp eq i32 %4, 1
  br i1 %8, label %14, label %9

9:                                                ; preds = %6
  %10 = add nuw nsw i32 %0, 14
  tail call void @gfx_text(i32 noundef %10, i32 noundef 52, ptr noundef nonnull @.str.14, i16 noundef zeroext 32351, i16 noundef zeroext 2147) #3
  %11 = icmp eq i32 %4, 3
  br i1 %11, label %12, label %14

12:                                               ; preds = %9
  %13 = add nuw nsw i32 %0, 26
  tail call void @gfx_text2(i32 noundef %13, i32 noundef 38, ptr noundef nonnull @.str.14, i16 noundef zeroext 32351, i16 noundef zeroext 2147) #3
  br label %14

14:                                               ; preds = %2, %6, %12, %9
  %15 = add nuw nsw i32 %0, 47
  tail call void @gfx_damage(i32 noundef %0, i32 noundef 38, i32 noundef %15, i32 noundef 73) #3
  ret void
}
